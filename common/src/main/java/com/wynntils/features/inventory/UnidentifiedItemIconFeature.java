...
public class UnidentifiedItemIconFeature extends Feature {
    private static final Map<GearType, Pair<Integer, Integer>> TEXTURE_COORDS = Map.ofEntries(
            Map.entry(GearType.SPEAR, Pair.of(16, 16)),
            Map.entry(GearType.WAND, Pair.of(0, 16)),
            Map.entry(GearType.DAGGER, Pair.of(16 * 2, 16)),
            Map.entry(GearType.BOW, Pair.of(16 * 3, 16)),
            Map.entry(GearType.RELIK, Pair.of(0, 16 * 2)),
            Map.entry(GearType.RING, Pair.of(16, 16 * 2)),
            Map.entry(GearType.BRACELET, Pair.of(16 * 2, 16 * 2)),
            Map.entry(GearType.NECKLACE, Pair.of(16 * 3, 16 * 2)),
            Map.entry(GearType.HELMET, Pair.of(0, 0)),
            Map.entry(GearType.CHESTPLATE, Pair.of(16, 0)),
            Map.entry(GearType.LEGGINGS, Pair.of(16 * 2, 0)),
            Map.entry(GearType.BOOTS, Pair.of(16 * 3, 0)),
            Map.entry(GearType.MASTERY_TOME, Pair.of(0, 16 * 3)),
            Map.entry(GearType.CHARM, Pair.of(16, 16 * 3)));
