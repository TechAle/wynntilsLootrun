...
public class ContentBookDumpFeature extends Feature {
    ...
    public void onSetSpawn(SetSpawnEvent event) {
        ...
        Location currentTracker = ActivityModel.ACTIVITY_MARKER_PROVIDER.getSpawnLocation();
    ...
    private void trackManually() {
        ...
        lastTrackedLocation = ActivityModel.ACTIVITY_MARKER_PROVIDER.getSpawnLocation();
